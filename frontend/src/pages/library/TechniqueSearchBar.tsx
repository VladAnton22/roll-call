  ...
  return (
    <div className="relative mb-5">
      ...
      <input
        ...
        className="w-full bg-surface-input border border-chrome rounded-xl pl-10 pr-4 py-2.5 text-sm text-content-secondary placeholder-content-faint focus:outline-none focus:border-brand-border focus:ring-1 focus:ring-brand-border transition-colors"
      />
      {value && (
        <button
          onClick={() => onChange("")}
